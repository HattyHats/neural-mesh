...
import { Skull, AlertTriangle, ShieldAlert, Calendar as CalendarIcon, Download, Flame, Info, Lock, Image as ImageIcon, Search, Undo, Redo, Activity, Settings as SettingsIcon, Network, Save } from 'lucide-react';
...
export default function App() {
  ...
  const getBackground = () => {
     switch(theme) {
       case 'cyberpunk': return 'linear-gradient(135deg, #2e0854, #000000, #0a192f)';
       case 'space': return 'radial-gradient(circle at center, #1b2735 0%, #090a0f 100%)';
  ...
  return (
    <div 
      style={{ width: '100vw', height: '100vh', position: 'relative', overflow: 'hidden', background: getBackground(), color: '#fff' }}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <ul style={{ lineHeight: '1.6', marginBottom: '25px' }}>
              ...
              <li><strong>Privacy & Security:</strong> Everything is encrypted. You can Lock individual thoughts or your entire brain using the Vault mechanics.</li>
            </ul>
            ...
            <ul style={{ lineHeight: '1.6' }}>
              ...
              <li><strong>Image Nodes:</strong> Start a thought's title with <code>/img [URL]</code> to turn the node into a floating image.</li>
